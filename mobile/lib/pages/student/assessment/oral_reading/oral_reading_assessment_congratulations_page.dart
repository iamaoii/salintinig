...
class OralReadingAssessmentCongratulationsPage extends StatefulWidget {
  final int score;
  final int totalQuestions;

  const OralReadingAssessmentCongratulationsPage({
    super.key,
    required this.score,
  ...
  @override
  State<OralReadingAssessmentCongratulationsPage> createState() =>
      _OralReadingAssessmentCongratulationsPageState();
}

class _OralReadingAssessmentCongratulationsPageState
    extends State<OralReadingAssessmentCongratulationsPage> {
