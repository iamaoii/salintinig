...
class _StudentOverviewPageState extends State<StudentOverviewPage> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                _buildQuickNavCard('Phil-IRI', Ph.file_text, primaryBlue),
                                _buildQuickNavCard('Library', Ph.book_open, primaryBlue),
                                _buildQuickNavCard('Activities', Ph.flag, primaryBlue),
                                _buildQuickNavCard('Progress', Ph.hourglass, primaryBlue),
                              ],
                            ),
                            const SizedBox(height: 28),

                            // ── Section 1: Phil-IRI Assessments ──
                            _buildSectionHeader('Phil - IRI Assessments', Ph.file_text),
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                _buildSectionHeader('Continue Reading', Ph.book_open),
                                Text(
                                  'See all',
                                  style: GoogleFonts.inter(
                                    color: primaryBlue,
                            ...
                            _buildSectionHeader('Activities', Ph.game_controller),
                            const SizedBox(height: 12),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                _buildActivityCard('Pronunciation\nChallenge', Ph.microphone_stage, const Color(0xFFE3F2FD), primaryBlue),
                                _buildActivityCard('Vocabulary\nMatching', Ph.equals, const Color(0xFFFEF9E7), const Color(0xFFEAB308)),
                                _buildActivityCard('Sentence\nArrangement', Ph.wrench, const Color(0xFFECFDF5), const Color(0xFF10B981)),
                              ],
                            ),
                            const SizedBox(height: 28),

                            // ── Section 4: Progress (from Picture 2) ──
                            _buildSectionHeader('Progress', Ph.chart_bar),
                            const SizedBox(height: 12),
                            // Stat Row
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                              children: [
                                _buildStatItem('5', 'Stories', Ph.books, primaryBlue),
                                _buildStatItem('5', 'Badges', Ph.shield, primaryBlue),
                                _buildStatItem('5', 'Streak', Ph.fire, primaryBlue),
                              ],
                            ),
                            const SizedBox(height: 20),
                            // Accuracy Chart Card
  ...
  Widget _buildContinueReadingCard(BuildContext context) {
    const cardBg = Color(0xFFFFFDF5); // Stylized soft yellow tint
    const tagBg = Color(0xFFD1FAE5);
    ...
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Dynamic offline vector book cover representation
          Container(
            width: 84,
            height: 114,
            decoration: BoxDecoration(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Iconify(Ph.sun, color: Colors.white, size: 18),
                Text(
                  'SARI-SARI\nSUMMERS',
                  style: GoogleFonts.inter(
                    color: Colors.white,
          ...
          // Book detail text & Continue trigger
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
  ...
  Widget _buildActivityCard(String label, String iconSvg, Color iconBg, Color iconColor) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFF4F4F5), width: 1.0),
      ),
      child: Material(
        color: Colors.transparent,
        child: InkWell(
